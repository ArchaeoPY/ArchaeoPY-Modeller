...
#
# Created: Wed Nov 05 12:37:09 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(9, 20, 291, 151))
        ...
        self.gridLayout_2.addWidget(self.doubleSpinBox_samplingint, 2, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.doubleSpinBox_fieldinclination, 3, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.doubleSpinBox_traverseint, 1, 1, 1, 1)
        self.label_samplingint = QtGui.QLabel(self.gridLayoutWidget)
        self.label_samplingint.setObjectName(_fromUtf8("label_samplingint"))
        self.gridLayout_2.addWidget(self.label_samplingint, 2, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_fieldinclination, 3, 0, 1, 1)
        self.groupBox_method = QtGui.QGroupBox(self.groupBox_survey)
        self.groupBox_method.setGeometry(QtCore.QRect(0, 190, 301, 111))
        self.groupBox_method.setObjectName(_fromUtf8("groupBox_method"))
        self.gridLayoutWidget_4 = QtGui.QWidget(self.groupBox_method)
        self.gridLayoutWidget_4.setGeometry(QtCore.QRect(10, 20, 281, 91))
        ...
        self.radioButton_res.setChecked(True)
        self.radioButton_res.setObjectName(_fromUtf8("radioButton_res"))
        self.buttonGroup_ResMag = QtGui.QButtonGroup(MainWindow)
        self.buttonGroup_ResMag.setObjectName(_fromUtf8("buttonGroup_ResMag"))
        self.buttonGroup_ResMag.addButton(self.radioButton_res)
        ...
        self.buttonGroup_ResMag.addButton(self.radioButton_mag)
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(0, 24, 301, 251))
        ...
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(10, 20, 294, 221))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_traverseint.setText(_translate("MainWindow", "Traverse Interval", None))
        self.label_samplingint.setText(_translate("MainWindow", "Sampling Interval", None))
        self.label_traverselength.setText(_translate("MainWindow", "Traverse Length", None))
        ...
        self.label_width.setText(_translate("MainWindow", "Width", None))
        self.label_8.setText(_translate("MainWindow", "Depth Extent", None))
        self.label_conductivity.setText(_translate("MainWindow", "Conductivity", None))
        self.label_length.setText(_translate("MainWindow", "Length", None))
        ...
        self.label_depth.setText(_translate("MainWindow", "Depth", None))
        self.label_magsus.setText(_translate("MainWindow", "Magnetic Susceptibility", None))
        self.label_strike.setText(_translate("MainWindow", "Strike", None))
        self.groupBox_instrument.setTitle(_translate("MainWindow", "Instrument Parameters", None))
        self.label_lowersensor.setText(_translate("MainWindow", "Lower Sensor Height", None))
        ...
        self.label_uppersensor.setText(_translate("MainWindow", "Upper Sensor Height", None))
